...
PHP_ARG_ENABLE(sleepy, whether to enable Sleepy extension, [  --enable-sleepy   Enable Sleepy extension])

if test "$PHP_SLEEPY" != "no"; then

  dnl this defines the extension
  PHP_NEW_EXTENSION(sleepy, sleepy.c, $ext_shared)
